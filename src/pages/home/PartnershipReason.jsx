    ...
    return (
        <div className="bg-[#F9F9F9]">
            ...
            <section className="pt-20 pb-14">
                <h1 className=" text-2xl text-center font-bold">আইওনিক কর্পোরেশন সাথে অংশীদার হওয়ার ৬ <br /> টি কারণ</h1>
            </section>
            <section className="max-w-screen-xl mx-auto grid grid-cols-3 gap-10 px-20">
                <div className="border bg-[#F7F7F7] w-[350px] flex flex-col justify-center items-center p-2">
                ...
                <div className="border bg-[#F7F7F7] w-[350px] flex flex-col justify-center items-center p-2 pb-20">
                ...
                <div className="border bg-[#F7F7F7] w-[350px] flex flex-col justify-center items-center p-2 pb-24">
            ...
            <section className="text-[#7d7d7d]">
                <div className="flex flex-col justify-center items-center py-5">
                    <h1 className="text-3xl font-bold text-black py-3">চল শুরু করি</h1>
                    ...
                    <div className="flex gap-10 pb-5 py-10">
                        <div >
                            <h1 className="text-center text-xl font-bold">আপনি কি আপনার ব্যবসা পরিচালনার জন্য প্রস্তুত?</h1>
                            <p className="text-center text-xl">আপনার মোবাইল ফোন নম্বরটি রেখে দিন, আমরা আপনাকে কল করব।</p>
                        </div>
                        <div>   <p className="text-white bg-[#FF0020] rounded-[4px] h-6 text-[12px] px-3 font-bold pt-[1px]">Request for Demo</p></div>
                    ...
                    <footer>
                        <div className="flex flex-col justify-center items-center py-10">
                            ...
                            <p className="text-center px-[480px]">
