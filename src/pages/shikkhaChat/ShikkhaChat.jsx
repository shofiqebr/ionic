    ...
    return (
        ...
        <div className=' bg-[#F3F3F3]'>
            ...
            <section className='flex md:flex-row flex-col-reverse gap-10'>
                <div className='md:w-1/2 '>
                     <section className="text-left ">
                        <div className="lg:text-[30px] text-xl font-semibold  leading-10">
                        বাংলাদেশে প্রথমবার <span className='text-[#F8001F]'>শিক্ষা চ্যাট </span> সফটওয়্যার দিয়ে আপনার এডুকেশন ব্যবসার <span className='text-[#F8001F]'>টোটাল সলুয়েশন</span>  জন্য পাইথন দ্বারা তৈরি একমাত্র শিক্ষা চ্যাট ইআরপি সফ্টওয়ার উপস্থাপন করলো <span className='text-[#F8001F]'>IONIC Corporation.</span> 
                        </div>
                        <div className="xl:w-[550px] lg:w-[xl0px] mt-5 h-1 bg-[#F8001F]"></div>
                        <div className='text-[#828282] md:text-lg font-bold pt-2'>শিক্ষা চ্যাট ইআরপি- স্মার্টফোন, ট্যাব, আইফোন, আইপ্যাড, ম্যাক এবং পিসিতে এমনকি অনলাইন বা অফলাইনেও কাজ করে।
                        </div>
                     </section>
                </div>
                <div className='md:w-1/2 md:p-44 p-5'>
                    <img src={shikkhaImg} alt="" />
                </div>
            </section>
            <section >
                <ul className='flex md:flex-row flex-col gap-5 justify-center items-center py-5
                '>
                    <li className='p-2 px-5 w-44 text-center bg-black font-bold rounded-full text-white '>school <br /> website</li>
                    <li className='p-2 px-5 w-44 text-center bg-[#F8001F] font-bold rounded-full text-white '>Admin/Teacher <br /> Login</li>
                    <li className='p-2 px-5 w-44 text-center bg-[#F8001F] font-bold rounded-full text-white '>Student/Parent <br /> Login</li>
                    <li className='p-2 px-5 w-44 text-center bg-black font-bold rounded-full text-white '>Android <br /> Demo </li>
                </ul>
            </section>
            ...
            <article className='py-10'>
                ...
                <section className='text-center text-[#828282] text-lg
                '>
