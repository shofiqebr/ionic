...
<h1 className="lg:text-[29px] xl:text-[23px] text-[22px] md:text-[25px] font-semibold lg:pb-8 heading2">ডিজিটাল আইটি সলিউশন প্রতিষ্ঠান</h1>
                    ...
                    রাসায়নিক শিল্পের জন্য আইওনিক কর্পোরেশন বাংলাদেশে প্রথমবার সবচেয়ে সহজ ও নির্ভূল ব্যবসা পরিচালনার পূর্নাঙ্গ সমাধান নিয়ে এলো পাইথন দিয়ে তৈরি "আইওনিক ইআরপি" টোটাল সলুয়েশন ইআরপি সফ্টওয়ার।
                    </p>
                    <p className="lg:text-[18px] xl:text-[16px] 2xl:text-[18px] lg:py-5 text-justify md:w-[350px] lg:w-auto p-5  md:pt-20 lg:pt-5 ">
                    আপনি যদি রাসায়নিক শিল্পের জন্য রাসায়নিক এবং সংশ্লিষ্ট পণ্য উৎপাদনের ব্যবসায় থাকেন তবে সমস্ত জটিল ক্রিয়াকলাপ পরিচালনার জন্য আপনার ওয়ান স্টপ সমাধান হতে পারে "আইওনিক ইআরপি" টোটাল সলুয়েশন ইআরপি সফ্টওয়ার। উত্পাদন, বিতরণ থেকে রপ্তানি পর্যন্ত রাসায়নিক শিল্পের সাথে কাজ করার আমাদের অভিজ্ঞতা আপনাকে অপারেশনগুলিকে স্ট্রিমলাইন করতে, দক্ষতা উন্নত করতে এবং সামগ্রিক উত্পাদনশীলতা বাড়াতে সহায়তা করতে পারে।
                    </p>
