    ...
    return (
        ...
        <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 lg:px-16 px-5 md:px-3 pt-10 '>
            <div className='pb-10 bg-white pt-3  px-5  flex flex-col gap-4  items-center md:relative group transition duration-300 hover:shadow-xl rounded-md border'>
                <img className='p-5 w-32 h-32' src={finance} alt="" />
                <h2 className='font-bold '> অ্যাকাউন্টিং ও হিসাবরক্ষণ</h2>
            ...
            <div  className='pb-10 bg-white p-3 px-5  flex flex-col gap-4  items-center md:relative group transition duration-300 hover:shadow-xl rounded-md border'>
                <img className='p-5 w-32 h-32'src={human} alt="" />
                <h2 className='font-bold '>এইচআর এবং বেতন</h2>
                <p className='text-center  text-[#5e5d5d] flex-grow'>“IONIC ERP” কর্মীদের নিয়োগ এবং পরিচালনা এবং উপস্থিতি, ট্র্যাক পাতা এবং খরচ এবং অনবোর্ডিং, প্রশিক্ষণ এবং মূল্যায়ন পরিচালনা করা সহজ এবং দক্ষ করে তোলে। কনফিগারযোগ্য বেতন কাঠামো এবং ব্যক্তিগতকৃত পেস্লিপ সহ বেদনাহীনভাবে বেতন প্রক্রিয়া করুন।
</p>
                {/* <a href="https://ionicerp.xyz/"className='bg-[#0C2A63] text-white p-3 rounded text-sm font-bold  transform lg:opacity-0 lg:group-hover:opacity-100 lg:group-hover:block lg:group-hover:-translate-y-5 transition duration-300 ease-in-out lg:absolute  -bottom-9'>বিস্তারিত</a> */}
            </div>
            ...
            <div  className='pb-10 bg-white p-3 px-5  flex flex-col gap-4  items-center md:relative group transition duration-300 hover:shadow-xl rounded-md border'>
                ...
                <h2 className='font-bold '>প্রস্তুতকারী / উৎপাদন</h2>
            ...
            <div  className='pb-10 bg-white p-3 px-5  flex flex-col gap-4  items-center md:relative group transition duration-300 hover:shadow-xl rounded-md border'>
                <img className='p-5 w-32 h-32' src={sales} alt="" />
                <h2 className='font-bold '>বিক্রয় এবং ক্রয়</h2>
            ...
            <div  className='pb-10 bg-white p-3 px-5  flex flex-col gap-4  items-center md:relative group transition duration-300 hover:shadow-xl rounded-md border'>
                ...
                <h2 className='font-bold '>ওয়েবসাইট </h2>
                <p className='text-center  text-[#5e5d5d] flex-grow'>“IONIC ERP” ব্লগ, ওয়েব পৃষ্ঠা এবং ফর্ম সহ সম্পূর্ণ বৈশিষ্ট্যযুক্ত বিষয়বস্তু পরিচালনার সাথে আসে। একটি প্ল্যাটফর্ম যা আপনাকে মিনিটের মধ্যে আপনার ওয়েব উপস্থিতি তৈরি, ডিজাইন, পরিচালনা এবং বিকাশ করার স্বাধীনতা দেয়।</p>
                {/* <a href="https://ionicerp.xyz/"className='bg-[#0C2A63] text-white p-3 rounded text-sm font-bold  transform lg:opacity-0 lg:group-hover:opacity-100 lg:group-hover:block lg:group-hover:-translate-y-5 transition duration-300 ease-in-out lg:absolute  -bottom-9'>বিস্তারিত</a> */}

                
            </div> 
            <div  className='pb-10 bg-white p-3 px-5  flex flex-col gap-4  items-center md:relative group transition duration-300 hover:shadow-xl rounded-md border'>
                <img className='p-5 w-32 h-32' src={customer} alt="" />
                <h2 className='font-bold '>সিআরএম</h2>
            ...
            <div  className='pb-10 bg-white p-3 px-5  flex flex-col gap-4  items-center md:relative group transition duration-300 hover:shadow-xl rounded-md border'>
                <img className='p-5 w-32 h-32' src={project} alt="" />
                <h2 className='font-bold '>প্রকল্প</h2>
            ...
            <div  className='pb-10 bg-white p-3 px-5  flex flex-col gap-4  items-center md:relative group transition duration-300 hover:shadow-xl rounded-md border'>
                <img className='p-5 w-32 h-32' src={data} alt="" />
            ...
            <div  className='pb-10 bg-white p-3 px-5  flex flex-col gap-4  items-center md:relative group transition duration-300 hover:shadow-xl rounded-md border'>
                <img className='p-5 w-32 h-32' src={vendor} alt="" />
                <h2 className='font-bold '>সাহায্য ডেস্ক</h2>
