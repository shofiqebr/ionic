...
// import  from '../../../../assets/erp/plastic.png'
...
const ProductDetailsErp = () => {
    return (
        <div className='pb-5 detailsWidth'>
        <section className='flex flex-col justify-center items-center gap-2 mt-10'>
            <h1 className=' text-[#898989] text-xl font-semibold '>``আইওনিক ইআরপি`` বিজনেস ম্যানেজমেন্ট সফটওয়্যার এর ব্যবহারের সেক্টর সমূহ</h1>
