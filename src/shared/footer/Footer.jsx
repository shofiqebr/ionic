...
const Footer = () => {
    return (
        <div className="bg-[#F9F9F9]">
            ...
            <section className="max-w-screen-xl mx-auto grid md:grid-cols-3 grid-cols-1 lg:gap-10 md:gap-5 lg:px-20 px-2">
                <div className="border bg-[#F7F7F7] xl:w-[350px] flex flex-col justify-center items-center p-2">
                    <p className="text-5xl text-black -mt-8"><IoMdChatbubbles /></p>
                ...
                <div className="border bg-[#F7F7F7] xl:w-[350px] flex flex-col justify-center items-center p-2 pb-20">
                    <p className="text-5xl text-black -mt-8"><GiGraduateCap /></p>
                    <h1 className="py-3 font-bold text-xl">অভিজ্ঞ পেশাদার</h1>
                    <p className="text-center text-[#898989] text-[16px]">আমরা বিগত 14+ বছর ধরে 100+ অভিজ্ঞ ইআরপি ব্রেইনের সাথে ইআরপি সলিউশন পরিবেশন করে আসছি এবং প্রযুক্তি, শিল্প এবং অ্যাপ্লিকেশন প্রকারের বিস্তৃত বর্ণালী সহ বিশ্ব বাজারের প্রয়োজনীয়তা পূরণ করছি।</p>
                </div>
                <div className="border bg-[#F7F7F7] xl:w-[350px] flex flex-col justify-center items-center p-2 pb-20">
                    <p className="text-5xl text-black -mt-8"><FaRegComment /></p>
                ...
                <div className="border bg-[#F7F7F7] xl:w-[350px] flex flex-col justify-center items-center p-2 pb-24">
                    <p className="text-5xl text-black -mt-8"><IoIosPaper /></p>
                ...
                <div className="border bg-[#F7F7F7] xl:w-[350px] flex flex-col justify-center items-center p-2 pb-20">
                    <p className="text-5xl text-black -mt-8"><FaShop /></p>
                    <h1 className="py-3 font-bold text-xl">ওয়ান স্টপ শপ</h1>
                    <p className="text-center text-[#898989] text-[16px]">আমরা ইআরপি সফ্টওয়্যারের সমস্ত দিক পরিচালনা করি যা আপনার ব্যবসায়িক কর্মক্ষমতা যেমন ইআরপি ডেভেলপমেন্ট, ইআরপি কাস্টমাইজেশন, ইআরপি প্রশিক্ষণ এবং অন্য যেকোন সম্পর্কিত ইআরপি চাহিদা বাড়াতে সহায়ক হতে পারে।</p>
                </div>
                <div className="border bg-[#F7F7F7] xl:w-[350px] flex flex-col justify-center items-center p-2 pb-20">
                    <p className="text-5xl text-black -mt-8"><FaRegSmileBeam /></p>
            ...
            <section className="text-[#7d7d7d]">
                <div className="flex flex-col justify-center items-center pt-20">
                    <h1 className="text-3xl font-bold text-black py-5">চল শুরু করি</h1>
                    <p className="text-white bg-[#FF0020] w-44 text-center rounded-[4px] h-6 text-[12px] px-3 font-bold py-[1px] mb-3">Request for Demo</p>
                    ...
                    <br />
                    <p className="text-center pb-20">শুধুমাত্র একটির পরিবর্তে বিভিন্ন সফ্টওয়্যারে সময় এবং অর্থ অপচয় করা বন্ধ করুন। আমাদের কোম্পানি অন্বেষণ করুন- IONIC Corporation.</p>

                    <div className="flex lg:flex-row flex-col gap-10 pb-5 py-10">
                        <div >
                        ...
                        <div>   <p className="text-white bg-[#FF0020] rounded-[4px] h-6 text-[12px] px-3 font-bold pt-[1px text-center mx-2">Request for Demo</p></div>
                        <div className="text-center text-lg">
                            <p className="text-center">অনুগ্রহ করে আমাকে কল করুন</p>
                            <p className="text-[#FF0020] font-bold text-2xl">01958 44 22 00</p>
                        </div>
                    </div>


                    <div className="px-2">
                        <div className="flex flex-col justify-center items-center py-10 text-sm text-center">
                            ...
                            <p className="text-center xl:px-[480px]">
                            ...
                            <img className="w-80 py-5" src={logo} alt="" />
                            ...
                            <p>Mobile No: 8801958442200</p>

                            <p className="text-center">Sales Line -8801958442200 <br />
                            Customer Care -8801511142320 (24/7 Live Support)</p>
                        </div>
                    </div>
                </div>
            </section>
